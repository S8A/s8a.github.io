...
So which rules are permissible and by what criteria? Richman proposes a non-disruption principle, that is, the principle must be to restrict or forbid only those actions which disrupt taxpayers' peaceful use of government-controlled property for its intended purpose.[^fn-6] Therefore, for example, doing drugs in a public park, defecating or camping on a public sidewalk, yelling in a public library, or walking naked into a public elementary school can all be rightfully forbidden by the goverment, and those who do those things can be expelled through (proportional) force if necessary. Crucially for the topic of immigration, this principle does not allow the government to forbid natives from hiring, hosting, trading with, or in general associating peacefully with anyone they want to, even if they're foreigners.
...
My point is that concerns about the effects of immigration on government spending and taxes, crime, and culture, as well as the geopolitical concerns explained in McMaken's article, are understandable and have a basis in reality. Demographics are important. Advocates of free immigration like Caplan and Richman too easily dismiss these concerns, though they're among the most logical and even-handed on the open borders camp. It's true, adherence to libertarian principles should be non-negotiable, as well as being accurate and not hysterical in evaluating practical effects, but I think a more complete analysis of the practical considerations at hand should make us not so optimistic about open borders. Furthermore, as I mentioned before and as I will elaborate next, libertarian legal theory does not imply that the government must have an open borders policy.
...
The final policy alternative, "restrictive immigration," is actually a very broad spectrum of policies; in fact, all governments of high-wage regions implement some kind of immigration restrictions. Hoppe favors "restrictive immigration" but not in any form; he argues that the restrictions that _should_ be imposed and that free marketeers _should_ be logically compelled to promote are those that follow from the guiding principle that immigration must be _invited immigration_, as explained before. To determine on the details of what this ideal policy implies, he starts from the conceptual benchmark of private property anarchy or anarcho-capitalism, and proceeds to elaborate from there. My main complaint with Hoppe's article is precisely that he should have started with this part, and left the speculative consequentialist arguments for the end.
...
[^fn-9]: Many immigration restrictionists are prone to claim that the statistics are somehow wrong or biased. Based on my attentive but non-thorough look at it, in my opinion the data provided by the Cato Institute is correct, though of course some sophisticated critiques may have merit. In any case, assume it's correct for the sake of argument.
