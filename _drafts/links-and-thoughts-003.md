...
Third, regarding the data presented by the Cato Institute, for example, it's focused on the United States which, despite popular claims to the contrary, has a labyrinthine, restrictive immigration policy,[^fn-7] and as a result is an imperfect selection effect toward higher income, less problematic immigrants than there would be under an open borders policy.[^fn-8] Therefore, it's wrong to non-chalantly extrapolate statistics about current immigrants in the United States[^fn-9] to predictions about the hypothetical immigrant population under an open borders policy. Logically, not only would the immigrant population be probably much greater, but it would be of a lower quality on average; _ceteris paribus_, the average immigrant would have lower intelligence, lower income, a higher propensity for crime, less compatibility with the local culture, and a higher likelihood to be a net tax burden than under the very imperfect restrictive status quo.

Look no further than the European Union countries, which have had a much more lenient and less selective immigration policy than the United States, and predictably they've received a disproportionally higher quantity of immigrants and of a notably lower quality on average, much more likely to be a net tax burden and to commit crimes than the native population. These issues have created strong anti-immigrant sentiments in Europe, and many have started reversing course, most notably Denmark.[^fn-10]
...
[^fn-7]: Yes, the United States does accept thousands and thousands of refugees and asylum seekers, progressive NGOs game the system to assist the "legal" entrance and subsidization of unwanted immigrants, and many unwanted immigrants illegally enter through the southern border, also in many cases with the support of progressive NGOs and shadowy financers, and that's bad. However, the truth is that their number is orders of magnitude smaller than it would probably be if the United States actually had an open borders policy or similar. Also, if I recall correctly most illegal immigrants are actually formerly legal immigrants that overstay their visa, but I don't have a source at hand (give me a break, this article is already long enough). The point is that the United States has a much more restrictive immigration policy than the average European Union country, for example, and their proportion of immigrants relative to the general population is also much smaller than in those countries, and again, much smaller than it would probably be under an open borders policy.
...
[^fn-10]: [_The Effects of Immigration in Denmark_](https://inquisitivebird.substack.com/p/the-effects-of-immigration-in-denmark) by Inquisitive Bird provides a comprehensive yet concise analysis of recent official statistics by the Danish government about the net fiscal contribution and the violent crime conviction shares of different demographic groups. Based on the fiscal contribution data, non-Western immigrants and their families have a notably lower average net fiscal contribution than natives and Western immigrants at all ages, and specially immigrants from MENAPT countries (Middle East, North Africa, Pakistan, and Turkey) have a net negative fiscal contribution (i.e., they're a net tax burden) at all ages. Based on the violent crime convictions data, again non-Western immigrants and their descendants are massively over-represented, even after adjusting for age and sex. If you don't trust the anonymous author, even The Economist can't hide this reality and provides the [same graphic of average net fiscal contributions by demographic](https://www.economist.com/img/b/608/662/90/sites/default/files/images/print-edition/20211218_EUC232.png) in their [_Why have Danes turned against immigration?_](https://www.economist.com/europe/2021/12/18/why-have-danes-turned-against-immigration) article. Regarding the particularly negative impact of MENAPT immigrants and their singling out in the fiscal contributions statistics, I must emphasize that the separate MENAPT category was introduced by the Danish government precisely because of the notably higher crime rates, lower employment rates, and less integration of immigrants from those countries; read [this article](https://migrant-integration.ec.europa.eu/news/denmark-new-statistics-category-migrants-muslim-countries_en). 
